...
public class ModeloUsuariosEnLinea extends AbstractListModel{
	private static final long serialVersionUID = 1L;
	ArrayList<Usuario> usuarios;
	private static ModeloUsuariosEnLinea instancia;
	
	public synchronized static ModeloUsuariosEnLinea getInstancia(){
		if (instancia == null){
			instancia = new ModeloUsuariosEnLinea();
		}
		return instancia;
	}
	
	private ModeloUsuariosEnLinea(){
